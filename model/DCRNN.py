...
class DCRNNModel_classification(nn.Module):
    ...
    def forward(self, input_seq, seq_lengths, supports, raw_adj=None):
        """
        Args:
        ...
        # Prefer explicit adjacency from caller; otherwise use support tensor as graph proxy.
        a_t_raw = raw_adj if raw_adj is not None else supports
        return pool_logits, last_out, a_t_raw
########## Model for seizure classification/detection ##########
