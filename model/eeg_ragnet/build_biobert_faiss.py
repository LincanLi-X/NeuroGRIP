...
def parse_args():
    parser = argparse.ArgumentParser("Build BioBERT triplet embeddings and FAISS index for EEG-RAGNet.")
    parser.add_argument(
        "--kg_json_path",
        type=str,
        default="model/eeg_ragnet/KG_triplets.json",
        help="Input KG json (flat triplets or page-level with triplets field).",
    )
    parser.add_argument(
        "--out_triplets_path",
        type=str,
        default="model/eeg_ragnet/KG_triplets_flat.json",
        help="Output flattened triplets aligned with FAISS ids.",
    )
    parser.add_argument(
        "--out_index_path",
        type=str,
        default="model/eeg_ragnet/faiss.index",
