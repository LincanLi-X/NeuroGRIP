...
def get_args():
    ...
    parser.add_argument('--kg_triplets_path', type=str, default='model/eeg_ragnet/KG_triplets.json',
                        help='Path to flat, FAISS-aligned triplets generated by build_biobert_faiss.py')
    parser.add_argument('--faiss_index_path', type=str, default='model/eeg_ragnet/faiss.index',
